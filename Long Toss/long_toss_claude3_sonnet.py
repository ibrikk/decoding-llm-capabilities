...
class LongToss:
    ...
    def farEnough(self):
        ...
        while velocity > 0:
            distance += velocity
            if distance >= self.__targetDistance:
                return True
...
def main():
    ...
    print(f"farEnough: {toss.farEnough()}")  # Output: farEnough: False
    print(f"totalDistance: {toss.totalDistance()}")  # Output: totalDistance: 9
