...
def main():
    # Testing the LongToss class
    toss = LongToss(5, 10, 2)
    print("Will the ball reach the target distance?", toss.farEnough())  # Output: False
    print("Total distance the ball travels:", toss.totalDistance())  # Output: 9
